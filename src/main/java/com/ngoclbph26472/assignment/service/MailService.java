...
import com.ngoclbph26472.assignment.model.MailModel;
...
//        helper.setFrom(mail.getFrom());
        ...
        helper.setText((String) mail.getBody(),true);//true được sử dụng để xác định liệu nội dung của chuỗi được định dạng hay không.
